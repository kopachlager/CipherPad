...
const AuthenticatedLayout: React.FC = () => {
  ...
  }, [isDashboardRoute, showDashboard, setShowDashboard]);
        ...
        <div className="fixed inset-0 z-[100] bg-black/50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-6 max-w-sm w-full text-center">
            ...
            <div className="flex items-center justify-center gap-3">
              <button onClick={() => unlockApp()} className="px-4 py-2 rounded-md bg-gray-900 text-white hover:bg-gray-800 transition-colors">
                Unlock
              </button>
            </div>
          </div>
